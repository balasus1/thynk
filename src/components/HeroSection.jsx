    ...
    <div className="max-w-7xl mx-auto pt-20 px-6">
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            ...
            <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
                We sprinkle creativity to your dreams, bring reality to your life by building
                 the best IT solutions for bussiness. 
                Sustainable solutions for converting low-profit to long running successful businesses.
            </p>
